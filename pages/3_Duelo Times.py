...
TEAM_LOGOS = {
    ...
    'Vasco da Gama': 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Escudo_Vasco_1920.png/640px-Escudo_Vasco_1920.png',
...
def display_metrics(metrics, current_pos, df_head_to_head):
    ...
    if not df_head_to_head.empty:
        ...
        for _, row in df_head_to_head.iterrows():
            ...
            st.markdown(
                f'<span style="color: {color_hex};"><b>Resultado: {score} - Jogo {ordem_jogo} - Local {local} - Ano {ano}</b></span>', 
                unsafe_allow_html=True
            )
